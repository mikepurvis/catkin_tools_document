...
def create_job(context, package, package_path, deps):
    ...
    docs_build_space = os.path.join(context.package_build_space(package), 'docs')
    ...
    stages.append(FunctionStage('mkdir', makedirs, path=docs_space))
    stages.append(FunctionStage('mkdir', makedirs, path=docs_build_space))
    ...
    for conf in rosdoc_conf:
        stages.append(getattr(builders, conf['builder'])(
